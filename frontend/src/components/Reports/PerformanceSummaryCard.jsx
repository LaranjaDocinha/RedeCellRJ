...
import './PerformanceSummaryCard.scss'; // Assuming a SCSS file for styling

const PerformanceSummaryCard = ({ title, value, iconClass, animationDelay = 0 }) => {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: animationDelay, duration: 0.5 }}
      className="performance-summary-card-wrapper"
    >
