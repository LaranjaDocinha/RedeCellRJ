          ...
          <>
              ...
              <Stack spacing={3}>
                <Card sx={{ borderRadius: '24px', border: '1px solid', borderColor: 'divider', boxShadow: 'none' }}>
                  <CardContent sx={{ p: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" fontWeight={400}>iPhone 15 Pro</Typography>
                    <Typography variant="body2" color="text.secondary" gutterBottom>IMEI: {serial}</Typography>
                    <Chip label="STATUS: VENDIDO" color="success" sx={{ mt: 2, fontWeight: 400, borderRadius: '8px' }} />
                  </CardContent>
                </Card>

                <Paper sx={{ p: 3, borderRadius: '24px', border: '1px solid', borderColor: 'divider', bgcolor: 'action.hover' }}>
                  <Typography variant="subtitle2" fontWeight={400} mb={2}>Informações de Garantia</Typography>
                  <Stack spacing={2}>
                    <Box display="flex" justifyContent="space-between">
                      <Typography variant="caption" color="text.secondary">COBERTURA</Typography>
                      <Typography variant="caption" fontWeight={400} color="success.main">ATIVA</Typography>
                    </Box>
                    <Box display="flex" justifyContent="space-between">
                      <Typography variant="caption" color="text.secondary">EXPIRA EM</Typography>
                      <Typography variant="caption" fontWeight={400}>15/12/2026</Typography>
                    </Box>
                  </Stack>
                </Paper>
              </Stack>
            ...
            <Grid item xs={12} md={8}>
              <Paper sx={{ p: 4, borderRadius: '32px', border: '1px solid', borderColor: 'divider' }}>
                <Typography variant="h6" fontWeight={400} mb={4}>Linha do Tempo de Eventos</Typography>
                <Box>
                    ...
                    <Box key={event.id} sx={{ display: 'flex', gap: 3, pb: idx === history.length - 1 ? 0 : 4 }}>
                      ...
                      <Box flexGrow={1} pt={0.5}>
                        <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                          <Box>
                            <Typography variant="subtitle1" fontWeight={400}>{event.action}</Typography>
                            <Typography variant="caption" color="text.secondary" display="block">{moment(event.date).format('LLL')}</Typography>
                          </Box>
                          <Chip label={event.new_status} size="small" variant="outlined" sx={{ fontWeight: 400, borderRadius: '6px' }} />
                        </Box>
          ...
          <Grid item xs={12}>
            <Box textAlign="center" py={10}>
              <Paper sx={{ p: 10, borderRadius: '40px', border: '2px dashed', borderColor: 'divider', bgcolor: 'transparent' }}>
                ...
                <Typography variant="h5" color="text.secondary" fontWeight={400}>Aguardando IMEI para rastreamento</Typography>
