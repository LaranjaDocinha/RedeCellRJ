...
const PrintableRepairOrder = () => {
  ...
  if (!repair)
    return (
      <Alert className='m-5' color='warning'>
        Ordem de Serviço não encontrada.
      </Alert>
    );

  const totalPartsCost = repair.parts.reduce(
    (acc, part) => acc + part.quantity_used * part.unit_price_at_time,
    0,
  );
  ...
  return (
    <Container className='p-4' style={{ fontFamily: 'Arial, sans-serif', color: '#000' }}>
      ...
      <Row className='mb-4 align-items-center'>
        <Col xs={6}>
          <img alt='Logo da Loja' src={logo} style={{ maxHeight: '60px' }} />
        </Col>
      ...
      <Row className='mb-4'>
        <Col>
          ...
          <p className='mb-0'>
            <strong>Nome:</strong> {repair.customer_name}
          </p>
          <p className='mb-0'>
            <strong>Contato:</strong> {repair.customer_phone || repair.customer_email}
          </p>
        </Col>
      </Row>
      ...
      <Row className='mb-4'>
        <Col>
          ...
          <p className='mb-0'>
            <strong>Tipo:</strong> {repair.device_type}
          </p>
          <p className='mb-0'>
            <strong>Marca/Modelo:</strong> {repair.brand} {repair.model}
          </p>
          <p className='mb-0'>
          ...
          <Table bordered>
            ...
            <tbody>
              ...
              {repair.parts.map((part) => (
                <tr key={part.id}>
                  <td>
                    {part.quantity_used}x {part.product_name}
                  </td>
            ...
            <tfoot>
              <tr style={{ backgroundColor: '#f8f9fa' }}>
                ...
                <td className='text-end'>
                  <strong>R$ {totalPartsCost.toFixed(2)}</strong>
                </td>
              </tr>
              <tr style={{ backgroundColor: '#f8f9fa' }}>
                <td className='text-end'>
                  <strong>Custo Total (Serviço + Peças):</strong>
                </td>
                <td className='text-end'>
      ...
      <Row className='mb-5'>
        <Col>
          ...
          <small className='d-block mb-2'>
            2. Peças trocadas possuem garantia de 90 dias contra defeitos de fabricação. Danos por
            mau uso, quedas ou contato com líquidos não são cobertos.
          </small>
          <small className='d-block mb-2'>
            3. O aparelho deve ser retirado em até 90 dias após a notificação de conclusão. Após
            este prazo, o mesmo poderá ser vendido para cobrir os custos do reparo.
          </small>
        </Col>
      </Row>
