...
const UiToast = () => {
    ...
    //meta title
    document.title = "Toast | RedeCellRJ";
                                    ...
                                    <div className="d-flex flex-column gap-3">
                                                ...
                                                <ToastBody>
                                                    ...
                                                    <div className="mt-2 pt-2 border-top">
                                                        <button type="button" className="btn btn-primary btn-sm me-1">Take
                                                            action</button>
                                                        <button onClick={() => setToast6(false)} type="button" className="btn btn-secondary btn-sm"
                                                        >Close</button>
                                                    </div>
                                                </ToastBody>
                                            </Toast>
                                        ...
                                        >
                                            <div className="d-flex">
                                                ...
                                                <button onClick={() => setToast7(false)} type="button" className="btn-close me-2 m-auto"></button>
                                            </div>
                                        </Toast>
                                    </div>
                                </CardBody>
