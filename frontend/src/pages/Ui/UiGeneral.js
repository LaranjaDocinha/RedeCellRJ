...
import { Button, Popover, PopoverHeader, PopoverBody, Tooltip, Col, Row, Card, CardBody, CardTitle, CardSubtitle, Container, Spinner, Badge, UncontrolledPopover, Pagination, PaginationItem, PaginationLink } from "reactstrap";
...
const UiGeneral = () => {
  ...
  //meta title
  document.title = "General | RedeCellRJ";
