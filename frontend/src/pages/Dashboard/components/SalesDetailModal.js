...
import { Modal, ModalHeader, ModalBody, Table, Spinner, Alert } from 'reactstrap';
            ...
            <Table striped hover>
              ...
              <tbody>
                {sales.length > 0 ? sales.map(sale => (
                  ...
                  <tr>
                    <td colSpan="5" className="text-center">Nenhuma venda encontrada para este filtro no período.</td>
                  </tr>
                )}
              </tbody>
            </Table>
