  ...
  return (
    <Box p={4} sx={{ maxWidth: 1400, margin: '0 auto', bgcolor: 'background.default' }}>
      <Box mb={6} display="flex" justifyContent="space-between" alignItems="flex-end">
        ...
        <Chip icon={<Bolt />} label="GATEWAY ATIVO" color="success" sx={{ fontWeight: 900, borderRadius: '8px', px: 1 }} />
      </Box>
                ...
                >
                  <CardActionArea onClick={() => setSelectedCarrier(c.name)} sx={{ p: 2 }}>
                    <Box display="flex" alignItems="center" gap={2}>
                      <Avatar sx={{ bgcolor: c.color, fontWeight: 900, width: 48, height: 48 }}>{c.logo}</Avatar>
                      <Box flexGrow={1}>
        ...
        <Grid item xs={12} md={7}>
          <Stack spacing={3}>
            <Paper sx={{ p: 4, borderRadius: '24px', border: '1px solid', borderColor: 'divider' }}>
              <Typography variant="h6" fontWeight={800} mb={3}>Ações Disponíveis</Typography>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <Button 
                    ...
                    sx={{ borderRadius: '12px', py: 2, fontWeight: 700, borderStyle: 'dashed' }}
                  >
                    Ativar Novo Chip
                  </Button>
                </Grid>
                ...
                <Grid item xs={12}>
                  <Button 
                    ...
                    sx={{ borderRadius: '12px', py: 2, fontWeight: 800 }}
                  >
            ...
            <Paper sx={{ p: 4, borderRadius: '24px', border: '1px solid', borderColor: 'divider', bgcolor: 'action.hover' }}>
              <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                <Typography variant="subtitle1" fontWeight={800}>Credenciais de Integração</Typography>
        ...
        <Grid item xs={12} md={5}>
          <Stack spacing={3}>
            <Paper sx={{ p: 3, borderRadius: '24px', bgcolor: 'primary.main', color: 'white' }}>
              <Typography variant="subtitle2" fontWeight={800} gutterBottom>Status do Serviço</Typography>
              {loadingStatus ? (
                ...
                <Box display="flex" alignItems="center" gap={2} mt={2}>
                  ...
                  <Box>
                    <Typography variant="h5" fontWeight={900}>OPERACIONAL</Typography>
            ...
            <Paper sx={{ p: 3, borderRadius: '24px', bgcolor: '#1e1e1e', color: '#d4d4d4', height: '100%', minHeight: 400 }}>
              <Box display="flex" alignItems="center" gap={1} mb={2}>
                ...
                <Typography variant="subtitle2" fontWeight={800} sx={{ color: '#fff' }}>Eventos de Conectividade</Typography>
              </Box>
