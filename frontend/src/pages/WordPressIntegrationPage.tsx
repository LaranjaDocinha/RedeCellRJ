      ...
      <Box mb={6} display="flex" justifyContent="space-between" alignItems="flex-end">
        <Box>
          <Box display="flex" alignItems="center" gap={1.5} mb={1}>
            ...
            <Typography variant="overline" sx={{ fontWeight: 400, color: '#21759b', letterSpacing: 2 }}>
              E-COMMERCE BRIDGE
            </Typography>
          </Box>
        ...
        <Stack direction="row" spacing={2}>
          <Chip icon={<WebIcon />} label="SITE ONLINE" color="success" sx={{ fontWeight: 400, borderRadius: '8px', px: 1 }} />
        </Stack>
      </Box>
        ...
        <Grid item xs={12} lg={7}>
          <Stack spacing={3}>
            <Paper sx={{ p: 4, borderRadius: '32px', border: '1px solid', borderColor: 'divider' }}>
              <Typography variant="h6" fontWeight={400} mb={4}>Painel de Sincronização</Typography>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                  <Box sx={{ p: 3, borderRadius: '24px', bgcolor: 'action.hover', textAlign: 'center' }}>
                    ...
                    <Typography variant="subtitle2" fontWeight={400}>Produtos & Estoque</Typography>
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ p: 3, borderRadius: '24px', bgcolor: 'action.hover', textAlign: 'center' }}>
                    ...
                    <Typography variant="subtitle2" fontWeight={400}>Pedidos & Vendas</Typography>
              ...
              {isSyncing && (
                <Box mt={4}>
                  <Typography variant="caption" fontWeight={400} gutterBottom display="block">PROGRESSO DA SINCRONIA</Typography>
            ...
            <Paper sx={{ p: 4, borderRadius: '24px', border: '1px solid', borderColor: 'divider' }}>
              <Typography variant="h6" fontWeight={400} mb={3}>Configurações de Acesso</Typography>
              <Stack spacing={3}>
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Typography variant="body2" fontWeight={400}>Sincronização Automática (Webhooks)</Typography>
                  <Switch defaultChecked />
                </Box>
                <Button variant="contained" sx={{ borderRadius: '12px', py: 1.5, fontWeight: 400 }}>Salvar Configurações</Button>
              </Stack>
            </Paper>
          </Stack>
        </Grid>
        ...
        <Grid item xs={12} lg={5}>
          <Stack spacing={3} height="100%">
            <Paper sx={{ p: 3, borderRadius: '24px', bgcolor: '#21759b', color: 'white' }}>
              <Typography variant="subtitle2" fontWeight={400} gutterBottom>Status da Conexão</Typography>
              <Box display="flex" alignItems="center" gap={2} mt={2}>
                <CheckCircle sx={{ fontSize: 40 }} />
                <Box>
                  <Typography variant="h5" fontWeight={400}>CONECTADO</Typography>
            ...
            <Paper sx={{ p: 3, borderRadius: '24px', bgcolor: '#1e1e1e', color: '#d4d4d4', flexGrow: 1, minHeight: 400 }}>
              <Box display="flex" alignItems="center" gap={1} mb={2}>
                ...
                <Typography variant="subtitle2" fontWeight={400} sx={{ color: '#fff' }}>Sync Activity Console</Typography>
              </Box>
