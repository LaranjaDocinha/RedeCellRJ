...
module.exports = {
  ...
  rules: {
    ...
    'react/prop-types': ['warn', { ignore: ['PopperContent'] }], // Ignora propTypes para PopperContent
    ...
    camelcase: 'off', // Desativa a regra camelcase para evitar conflitos com snake_case da API
    'react/no-unescaped-entities': 'off', // Desativa a regra para evitar falsos positivos com caracteres especiais
  ...
  overrides: [
    {
      files: ['public/sw.js', 'build/sw.js'],
      rules: {
