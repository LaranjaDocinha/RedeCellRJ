...
permissionsRouter.get('/:id', async (req, res, next) => {
    try {
...
permissionsRouter.put('/:id', validate(updatePermissionSchema), async (req, res, next) => {
    try {
...
permissionsRouter.delete('/:id', async (req, res, next) => {
    try {
