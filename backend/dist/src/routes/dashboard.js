...
dashboardRouter.get('/', authMiddleware.authenticate, authMiddleware.authorize('read', 'Dashboard'), cacheMiddleware(), // Applied cache middleware
async (req, res, next) => {
    try {
        ...
        const filters = {
            ...
            product: product,
            region: region,
            comparePeriod: comparePeriod, // Adicionado comparePeriod
        };
