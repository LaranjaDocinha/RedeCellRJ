...
router.post('/process-multi-gateway', authMiddleware.authenticate, authMiddleware.authorize('create', 'Payment'), // Or a more specific permission
validate(processMultiGatewaySchema), async (req, res, next) => {
    try {
