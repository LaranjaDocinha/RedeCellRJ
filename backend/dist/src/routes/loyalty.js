...
router.get('/points', authMiddleware.authorize('read', 'Loyalty'), async (req, res, next) => {
    try {
...
router.post('/add-points', authMiddleware.authorize('create', 'Loyalty'), validate(pointsSchema), async (req, res, next) => {
    try {
...
router.post('/redeem-points', authMiddleware.authorize('update', 'Loyalty'), validate(pointsSchema), async (req, res, next) => {
    try {
...
router.get('/transactions', authMiddleware.authorize('read', 'Loyalty'), async (req, res, next) => {
    try {
        const userId = req.user.id;
