...
reviewsRouter.get('/product/:productId', authMiddleware.authorize('read', 'Review'), // Add authorization
async (req, res, next) => {
    try {
...
reviewsRouter.get('/:id', authMiddleware.authorize('read', 'Review'), // Add authorization
async (req, res, next) => {
    try {
...
// Create a new review
reviewsRouter.post('/', authMiddleware.authorize('create', 'Review'), // Add authorization
validate(createReviewSchema), async (req, res, next) => {
    try {
...
reviewsRouter.put('/:id', authMiddleware.authorize('update', 'Review'), // Add authorization
validate(updateReviewSchema), async (req, res, next) => {
    try {
...
reviewsRouter.delete('/:id', authMiddleware.authorize('delete', 'Review'), // Add authorization
async (req, res, next) => {
    try {
        const userId = req.user.id;
        const reviewId = parseInt(req.params.id);
