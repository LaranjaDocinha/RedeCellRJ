...
// Get all suppliers
suppliersRouter.get('/', authMiddleware.authorize('read', 'Supplier'), async (req, res, next) => {
    try {
...
// Get supplier by ID
suppliersRouter.get('/:id', authMiddleware.authorize('read', 'Supplier'), async (req, res, next) => {
    try {
...
suppliersRouter.post('/', authMiddleware.authorize('create', 'Supplier'), validate(createSupplierSchema), async (req, res, next) => {
    try {
...
suppliersRouter.put('/:id', authMiddleware.authorize('update', 'Supplier'), validate(updateSupplierSchema), async (req, res, next) => {
    try {
...
suppliersRouter.delete('/:id', authMiddleware.authorize('delete', 'Supplier'), async (req, res, next) => {
    try {
