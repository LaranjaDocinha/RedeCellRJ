...
productKitsRouter.get('/', async (req, res, next) => {
    try {
...
productKitsRouter.get('/:id', async (req, res, next) => {
    try {
...
productKitsRouter.post('/', validate(createProductKitSchema), async (req, res, next) => {
    try {
...
productKitsRouter.put('/:id', validate(updateProductKitSchema), async (req, res, next) => {
    try {
...
productKitsRouter.delete('/:id', async (req, res, next) => {
    try {
