...
export const getShiftReportSchema = z.object({
    shiftId: z.preprocess((val) => parseInt(String(val), 10), z.number().int().positive('Shift ID must be a positive integer')).optional(),
    startDate: z.string().datetime().optional(),
    endDate: z.string().datetime().optional(),
});
export const getCurrentShiftReport = catchAsync(async (req, res) => {
