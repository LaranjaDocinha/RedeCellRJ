...
export const userKeybindController = {
    ...
    async updateKeybind(req, res) {
        try {
            const userId = req.user.id; // Ensure user owns the keybind
