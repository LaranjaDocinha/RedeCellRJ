export const getCompatibleProducts = async (deviceId) => {
...
export const logARInteraction = async (customerId, productId) => {
    console.log(`Simulating logging AR interaction for customer ${customerId} with product ${productId}`);
