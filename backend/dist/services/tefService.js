...
class TefService {
     ...
     */
    async processTefTransaction(data) {
        const { transactionId, amount, paymentMethod, cardBrand, nsu, authorizationCode, installments, status, saleId, } = data;
        const pool = getPool();
     ...
     */
    async getTefTransactionStatus(transactionId) {
