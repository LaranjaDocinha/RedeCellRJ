...
export const calculateBreakEvenPoint = async (branchId, startDate, endDate) => {
    ...
    `;
        ...
        const breakEvenUnits = contributionMarginPerUnit > 0 ? totalFixedCosts / contributionMarginPerUnit : 0;
