...
describe('ruleEngineService', () => {
  ...
  describe('evaluate', () => {
    ...
    it('should evaluate multiple conditions (AND logic)', async () => {
      ...
      const actionsSuccess = await ruleEngineService.evaluate('customer.loyalty_status', factsSuccess);
  ...
  describe('evaluateCondition operators', () => {
      ...
      it('contains (string)', () => {
          ...
          expect(ruleEngineService.evaluateCondition('hello world', 'contains', 'universe')).toBe(false);
      });
      it('contains (array)', () => {
      ...
      it('notContains (string)', () => {
          expect(ruleEngineService.evaluateCondition('hello world', 'notContains', 'universe')).toBe(true);
          expect(ruleEngineService.evaluateCondition('hello world', 'notContains', 'world')).toBe(false);
      });
