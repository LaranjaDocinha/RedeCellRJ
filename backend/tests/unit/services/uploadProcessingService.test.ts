...
describe('UploadProcessingService', () => {
  ...
  describe('processImage', () => {
    it('should process image using sharp', async () => {
      ...
      const result = await uploadProcessingService.processImage(
        'input.jpg',
        'out',
        'file.jpg'
      );
    ...
    it('should accept custom options', async () => {
      ...
      await uploadProcessingService.processImage(
        'input.jpg',
        'out',
        'file.jpg',
        { width: 100, quality: 50, format: 'jpeg' }
      );
    ...
    it('should throw AppError on failure', async () => {
      ...
      await expect(uploadProcessingService.processImage('in', 'out', 'f.jpg'))
        .rejects.toThrow('Failed to process image for optimization');
    });
  });
