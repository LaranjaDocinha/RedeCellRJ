...
} from '../controllers/serializedItemController.js'; // TODO: Mover schemas para um arquivo comum
...
router.post(
  '/',
  validate(createSerializedItemSchema),
  serializedItemController.createSerializedItem,
);
...
router.get(
  ...
  serializedItemController.getSerializedItemsByVariationId,
);
router.put(
  '/:id',
  validate(updateSerializedItemSchema),
  serializedItemController.updateSerializedItem,
);
