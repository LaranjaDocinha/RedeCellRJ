...
} from '../controllers/leadController.js'; // Reusing schemas from controller for routes
...
leadsRouter.post(
  '/',
  authMiddleware.authorize('create', 'Lead'),
...
leadsRouter.put(
  '/:id',
  authMiddleware.authorize('update', 'Lead'),
...
leadsRouter.post(
  '/:id/activities',
  authMiddleware.authorize('create', 'LeadActivity'),
  validate(createLeadActivitySchema),
  leadController.addLeadActivity,
);
leadsRouter.get(
  '/:id/activities',
  authMiddleware.authorize('read', 'LeadActivity'),
