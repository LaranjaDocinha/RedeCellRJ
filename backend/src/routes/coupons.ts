...
// Get all coupons
couponsRouter.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// Get coupon by code
couponsRouter.get('/:code', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
couponsRouter.delete('/:code', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
couponsRouter.post(
  '/apply',
  authMiddleware.authorize('apply', 'Coupon'), // Assuming a permission 'apply:Coupon'
