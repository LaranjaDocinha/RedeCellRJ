...
// Get all discounts
discountsRouter.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// Get discount by ID
discountsRouter.get('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
discountsRouter.delete('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
