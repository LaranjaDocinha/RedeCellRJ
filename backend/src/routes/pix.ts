...
pixRouter.post(
  ...
  authMiddleware.authorize('create', 'PixPayment'), // Assuming a 'PixPayment' subject for authorization
  generatePixQrCode,
);
...
pixRouter.get(
  ...
  authMiddleware.authenticate,
  authMiddleware.authorize('read', 'PixPayment'), // Assuming 'read' permission for PixPayment
