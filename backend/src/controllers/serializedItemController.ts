...
export const createSerializedItem = async (req: Request, res: Response) => {
  try {
...
export const getSerializedItemById = async (req: Request, res: Response) => {
  try {
...
export const getSerializedItemBySerialNumber = async (req: Request, res: Response) => {
  try {
...
export const getSerializedItemHistory = async (req: Request, res: Response) => {
  try {
    const serialNumber = req.params.serialNumber;
...
export const getAllSerializedItems = async (req: Request, res: Response) => {
  try {
...
export const getSerializedItemsByVariationId = async (req: Request, res: Response) => {
  try {
...
export const updateSerializedItem = async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id, 10);
    if (isNaN(id)) {
      return res.status(400).json({ message: 'ID inválido.' });
...
export const deleteSerializedItem = async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id, 10);
    if (isNaN(id)) {
      return res.status(400).json({ message: 'ID inválido.' });
