...
interface PaymentGateway {
  createPaymentIntent(amount: number, currency: string, metadata?: Record<string, unknown>): Promise<any>;
...
class StripePaymentGateway implements PaymentGateway {
  ...
  async createPaymentIntent(amount: number, currency: string, metadata?: Record<string, string | null>): Promise<any> {
    try {
...
export const paymentService = {
  async createPaymentIntent(amount: number, currency: string, paymentMethodType: string = 'stripe', metadata?: Record<string, string | null>) {
