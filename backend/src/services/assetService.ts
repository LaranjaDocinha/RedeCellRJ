...
export const assetService = {
  ...
  async createAsset(payload: CreateAssetPayload): Promise<Asset> {
    ...
    const result = await getPool().query(
      'INSERT INTO assets (name, description, acquisition_date, initial_value, depreciation_method, useful_life_years, current_value, branch_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *',
      [
        name,
        description,
        acquisition_date,
  ...
  async updateAsset(id: number, payload: UpdateAssetPayload): Promise<Asset | undefined> {
    ...
    const newCurrentValue = this.calculateCurrentValue(
      updatedInitialValue,
      updatedAcquisitionDate,
      updatedDepreciationMethod,
      updatedUsefulLifeYears,
    );
