import type { EndpointV2 } from "../endpoint.js";
import type { HandlerExecutionContext } from "../middleware.js";
import type { MetadataBearer } from "../response.js";
import type { EndpointBearer, SerdeFunctions } from "../serde.js";
import type { BigDecimalSchema, BigIntegerSchema, BlobSchema, BooleanSchema, DocumentSchema, NumericSchema, StreamingBlobSchema, StringSchema, TimestampDateTimeSchema, TimestampDefaultSchema, TimestampEpochSecondsSchema, TimestampHttpDateSchema } from "./sentinels.js";
import type { StaticSchema } from "./static-schemas.js";
import type { TraitBitVector } from "./traits.js";
/**
